/******/ (function (modules) {
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                function parseQuery(query) {
                    ...
                    query.split("&").forEach(function (param) {
                        ...
                        var val =
                            parts.length > 0 ? decode(parts.join("=")) : null;
                ...
                function createRoute(record, location, redirectedFrom, router) {
                    var stringifyQuery =
                        router && router.options.stringifyQuery;
                ...
                var View = {
                    ...
                    render: function render(_, ref) {
                        ...
                        if (inactive) {
                            ...
                            var cachedComponent =
                                cachedData && cachedData.component;
                            if (cachedComponent) {
                                // #2301
                                // pass props
                ...
                var Link = {
                    ...
                    render: function render(h) {
                        ...
                        if (true) {
                            ...
                            if (
                                "event" in this.$options.propsData &&
                                !warnedEventProp
                            ) {
                                warn(
                                    false,
                        ...
                        if (this.tag === "a") {
                            ...
                            if (a) {
                                ...
                                var aAttrs = (a.data.attrs = extend(
                                    {},
                                    a.data.attrs
                                ));
                                aAttrs.href = href;
                ...
                function findAnchor(children) {
                    if (children) {
                        ...
                        for (var i = 0; i < children.length; i++) {
                            ...
                            if (
                                child.children &&
                                (child = findAnchor(child.children))
                            ) {
                                return child;
                            }
                        }
                ...
                function createMatcher(routes, router) {
                    ...
                    function addRoute(parentOrRoute, route) {
                        var parent =
                            typeof parentOrRoute !== "object"
                                ? nameMap[parentOrRoute]
                                : undefined;
                        // $flow-disable-line
                        createRouteMap(
                            [route || parentOrRoute],
                    ...
                    function redirect(record, location) {
                        ...
                        params = re.hasOwnProperty("params")
                            ? re.params
                            : params;
                ...
                function setupScroll() {
                    ...
                    var protocolAndPath =
                        window.location.protocol + "//" + window.location.host;
                    var absolutePath = window.location.href.replace(
                        protocolAndPath,
                        ""
                    );
                ...
                function scrollToPosition(shouldScroll, position) {
                    ...
                    if (isObject && typeof shouldScroll.selector === "string") {
                        ...
                        var el = hashStartsWithNumberRE.test(
                            shouldScroll.selector
                        ) // $flow-disable-line
                            ? document.getElementById(
                                  shouldScroll.selector.slice(1)
                              ) // $flow-disable-line
                        ...
                        if (el) {
                            var offset =
                                shouldScroll.offset &&
                                typeof shouldScroll.offset === "object"
                                    ? shouldScroll.offset
                                    : {};
                ...
                function isError(err) {
                    return (
                        Object.prototype.toString.call(err).indexOf("Error") >
                        -1
                    );
                }
                ...
                function flatMapComponents(matched, fn) {
                    return flatten(
                        matched.map(function (m) {
                            return Object.keys(m.components).map(function (
                                key
                            ) {
                                return fn(
                                    m.components[key],
                ...
                History.prototype.confirmTransition =
                    function confirmTransition(route, onComplete, onAbort) {
                        ...
                        if (
                            ...
                            route.matched[lastRouteIndex] ===
                                current.matched[lastCurrentIndex]
                        ) {
                            this.ensureURL();
                            if (route.hash) {
                                handleScroll(
                            ...
                            return abort(
                                createNavigationDuplicatedError(current, route)
                            );
                        }
                        ...
                        runQueue(queue, iterator, function () {
                            ...
                            var queue = enterGuards.concat(
                                this$1.router.resolveHooks
                            );
                            runQueue(queue, iterator, function () {
                                if (this$1.pending !== route) {
                                    return abort(
                ...
                var HTML5History = /*@__PURE__*/ (function (History) {
                    ...
                    HTML5History.prototype.setupListeners =
                        function setupListeners() {
                            ...
                            var supportsScroll =
                                supportsPushState && expectScroll;
                            ...
                            var handleRoutingEvent = function () {
                                ...
                                if (
                                    this$1.current === START &&
                                    location === this$1._startLocation
                                ) {
                                    return;
                                }
                    ...
                    HTML5History.prototype.push = function push(
                        ...
                        this.transitionTo(
                            ...
                            function (route) {
                                pushState(
                                    cleanPath(this$1.base + route.fullPath)
                                );
                                handleScroll(
                                    this$1.router,
                                    route,
                    ...
                    HTML5History.prototype.getCurrentLocation =
                ...
                function getLocation(base) {
                    ...
                    if (
                        ...
                        (pathLowerCase === baseLowerCase ||
                            pathLowerCase.indexOf(
                                cleanPath(baseLowerCase + "/")
                            ) === 0)
                    ) {
                ...
                var HashHistory = /*@__PURE__*/ (function (History) {
                    ...
                    HashHistory.prototype.setupListeners =
                        function setupListeners() {
                            var this$1 = this;
                            ...
                            var eventType = supportsPushState
                                ? "popstate"
                                : "hashchange";
                            window.addEventListener(
                                eventType,
                    ...
                    AbstractHistory.prototype.go = function go(n) {
                        ...
                        this.confirmTransition(
                            ...
                            function () {
                                ...
                                this$1.updateRoute(route);
                                this$1.router.afterHooks.forEach(function (
                                    hook
                                ) {
                                    hook && hook(route, prev);
                                });
                ...
                var prototypeAccessors = {
                    currentRoute: { configurable: true },
                };
                ...
                VueRouter.prototype.init = function init(
                    ...
                    if (
                        history instanceof HTML5History ||
                        history instanceof HashHistory
                    ) {
                ...
                VueRouter.prototype.getMatchedComponents =
                    function getMatchedComponents(to) {
                        var route = to
                            ? to.matched
                                ? to
                ...
                VueRouter.prototype.addRoute = function addRoute(
                    parentOrRoute,
                    route
                ) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function (global, setImmediate) {
                    ...
                    function assertProp(prop, name, value, vm, absent) {
                        ...
                        var haveExpectedTypes = expectedTypes.some(function (
                            t
                        ) {
                            return t;
                        });
                    ...
                    function getType(fn) {
                        var match =
                            fn && fn.toString().match(functionTypeCheckRE);
                        ...
                        // 2.6 v-slot syntax
                        {
                            if (el.tag === "template") {
                                ...
                                if (slotBinding$1) {
                                    ...
                                    var slotContainer = (slots[name$1] =
  ...
  \**************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /Users/davidenapolitano/Desktop/HTML-CSS-JS/Progetto_finale/project-39-1.1/deliverboh/resources/js/router.js */ "./resources/js/router.js"
                );
